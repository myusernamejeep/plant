...
ig.module('plugins.impact-tween.tween').requires('plugins.impact-tween.entity').defines(function () {
    ...
    ig.Tween = ig.Class.extend({
        ...
        init: function (obj, properties, duration, settings) {
            ...
            if (typeof properties == 'object' && properties.constructor === (new Array).constructor) {
                this._props = properties;
            } else {
                this._props = [properties];
            }
            if (typeof obj == 'object' && obj.constructor === (new Array).constructor) {
                this._objects = obj;
            } else {
                this._objects = [obj];
            }
        ...
        start: function () {
            ...
            for (var i = 0; i < this._objects.length; i++) {
                if (this._objects[i].tweens.indexOf(this) == -1) {
                    this._objects[i].tweens.push(this);
                }
